...
func build_public_fact_extensions_for_test(event_log: Node, gameplay_snapshot: Dictionary = {}, constitution_summary: Dictionary = {}, peer_cards: Dictionary = {}, local_peer_id_override: int = -1) -> Array[String]:
	return _build_public_fact_extensions(event_log, gameplay_snapshot, constitution_summary, peer_cards, local_peer_id_override)

func _build_public_fact_extensions(event_log: Node = null, gameplay_snapshot: Dictionary = {}, constitution_summary: Dictionary = {}, peer_cards: Dictionary = {}, local_peer_id_override: int = -1) -> Array[String]:
	var lines: Array[String] = []
